...
@section('title', 'Edit Pengajuan Kasbon')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">

        <a href="{{ route('employee.cash-advances.show', $cashAdvance->id) }}" class="btn btn-secondary">
    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('employee.cash-advances.update', $cashAdvance->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="alert alert-warning">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <ul class="mb-0">
                                        <li>Perubahan data pengajuan kasbon akan memerlukan persetujuan ulang</li>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('employee.cash-advances.show', $cashAdvance->id) }}" class="btn btn-light me-md-2">Batal</a>
