...
@section('title', 'Tambah Penjualan Harian')
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.daily-sales.store') }}" method="POST">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control @error('dough_brought') is-invalid @enderror" 
                                id="dough_brought" name="dough_brought" value="{{ old('dough_brought') }}" required>
                            @error('dough_brought')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('dough_remaining_unprinted') is-invalid @enderror" 
                                id="dough_remaining_unprinted" name="dough_remaining_unprinted" value="{{ old('dough_remaining_unprinted', 0) }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('dough_remaining_printed') is-invalid @enderror" 
                                id="dough_remaining_printed" name="dough_remaining_printed" value="{{ old('dough_remaining_printed', 0) }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('employee_expenses') is-invalid @enderror" 
                                id="employee_expenses" name="employee_expenses" value="{{ old('employee_expenses', 0) }}">
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('total_sales') is-invalid @enderror" 
                                id="total_sales" name="total_sales" value="{{ old('total_sales') }}" required>
                            @error('total_sales')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
