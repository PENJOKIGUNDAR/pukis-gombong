...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <a href="{{ route('admin.inventory.show', $item->id) }}" class="btn btn-secondary">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.inventory.update', $item->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('is_raw_material') is-invalid @enderror" 
                                    ...
                                    <option value="1" {{ old('is_raw_material', $item->is_raw_material) ? 'selected' : '' }}>Bahan Baku</option>
                                    <option value="0" {{ old('is_raw_material', $item->is_raw_material) ? '' : 'selected' }}>Perlengkapan</option>
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="last_restock_date" class="form-label">Tanggal Pembelian Terakhir</label>
                                <input type="date" class="form-control @error('last_restock_date') is-invalid @enderror" 
                                    id="last_restock_date" name="last_restock_date" value="{{ old('last_restock_date', $item->last_restock_date->format('Y-m-d')) }}" required>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('admin.inventory.show', $item->id) }}" class="btn btn-light me-md-2">Batal</a>
